...
thumbnail: /blog/posts/Etc/08/thumbnail-blob.webp
tags: ['etc']
---
...
![vercel-blob](/blog/posts/Etc/08/0.webp)
...
![create-blob](/blog/posts/Etc/08/2.blob.webp)
2. Store 이름을 입력하고 생성(Region: `Seoul`, Access: `Public`으로 설정)
![make-blob](/blog/posts/Etc/08/3.make-blob.webp)
3. 생성된 Store를 프로젝트에 **Connect**
![create-blob](/blog/posts/Etc/08/4.connect.webp)
...
vercel link
```
![vercel-blob-store](/blog/posts/Etc/08/5.connect-terminal.webp)

연결하면 `BLOB_READ_WRITE_TOKEN` 환경변수가 프로젝트에 자동으로 주입됩니다. 그리고 브라우저에서 바로 업로드하면 됩니다.

![vercel-blob-upload](/blog/posts/Etc/08/client-upload.webp)
