...
desc: 타입 vs 인터페이스
date: 2024-08-21
thumbnail: /blog/posts/TypeScript/typescript.png
---
...
- `UserType`에 마우스를 올리면, 해당 타입의 구조를 미리 볼 수 있습니다.
  ![UserType](/blog/posts/TypeScript/01/1.png)

- `UserInterface`에 마우스를 올리면, 그냥 `interface UserInterface`라고만 나옵니다.
  ![UserInterface](/blog/posts/TypeScript/01/2.png)
...
- `AdminUserType`에 마우스를 올리면, `AdminType`과 `UserType`이 병합된 것을 볼 수 있습니다.
  ![AdminUserType](/blog/posts/TypeScript/01/3.png)

- `AdminUserInterface`에 마우스를 올리면, `AdminUserInterface`만 나옵니다. (병합된 타입을 볼 수 없음)
  ![AdminUserInterface](/blog/posts/TypeScript/01/4.png)
...
![Manager](/blog/posts/TypeScript/01/5.png)
...
그럼 다시 에러가 뜹니다.
![Manager](/blog/posts/TypeScript/01/6.png)
...
![Manager](/blog/posts/TypeScript/01/7.png)
