...
thumbnail: /blog/posts/TypeScript/typescript.webp
---
...
- `UserType`에 마우스를 올리면, 해당 타입의 구조를 미리 볼 수 있습니다.
  ![UserType](/blog/posts/TypeScript/01/1.webp)

- `UserInterface`에 마우스를 올리면, 그냥 `interface UserInterface`라고만 나옵니다.
  ![UserInterface](/blog/posts/TypeScript/01/2.webp)
...
- `AdminUserType`에 마우스를 올리면, `AdminType`과 `UserType`이 병합된 것을 볼 수 있습니다.
  ![AdminUserType](/blog/posts/TypeScript/01/3.webp)

- `AdminUserInterface`에 마우스를 올리면, `AdminUserInterface`만 나옵니다. (병합된 타입을 볼 수 없음)
  ![AdminUserInterface](/blog/posts/TypeScript/01/4.webp)
...
![Manager](/blog/posts/TypeScript/01/5.webp)
...
그럼 다시 에러가 뜹니다.
![Manager](/blog/posts/TypeScript/01/6.webp)
...
![Manager](/blog/posts/TypeScript/01/7.webp)
