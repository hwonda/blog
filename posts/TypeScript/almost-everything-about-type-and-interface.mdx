...
- `UserType`에 마우스를 올리면, 해당 타입의 구조를 미리 볼 수 있습니다.
  ![UserType](/posts/TypeScript/01-almost-everything-about-type-and-interface/1.png)

- `UserInterface`에 마우스를 올리면, 그냥 `interface UserInterface`라고만 나옵니다.
  ![UserInterface](/posts/TypeScript/01-almost-everything-about-type-and-interface/2.png)
...
- `AdminUserType`에 마우스를 올리면, `AdminType`과 `UserType`이 병합된 것을 볼 수 있습니다.
  ![AdminUserType](/posts/TypeScript/01-almost-everything-about-type-and-interface/3.png)

- `AdminUserInterface`에 마우스를 올리면, `AdminUserInterface`만 나옵니다. (병합된 타입을 볼 수 없음)
  ![AdminUserInterface](/posts/TypeScript/01-almost-everything-about-type-and-interface/4.png)
...
![Manager](/posts/TypeScript/01-almost-everything-about-type-and-interface/5.png)
...
그럼 다시 에러가 뜹니다.
![Manager](/posts/TypeScript/01-almost-everything-about-type-and-interface/6.png)
...
![Manager](/posts/TypeScript/01-almost-everything-about-type-and-interface/7.png)
