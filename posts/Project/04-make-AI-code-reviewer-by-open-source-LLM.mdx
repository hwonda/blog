...
desc: 0원으로 코드래빗 만들기
date: 2025-05-09
thumbnail: /posts/Project/04/thumbnail.png
---
...
![coderabbit](/posts/Project/04/0.png)
...
![result](/posts/Project/04/result.png)
...
3. 퍼미션 점검
```bash
chmod +x /opt/mr-reviewer/mr_reviewer.py
```
...
ls -l /opt/mr-reviewer/mr_reviewer.py
```
> -rwxr-xr-x 1 root root 3085 Apr 30 07:00 /opt/mr-reviewer/mr_reviewer.py
...
![systemd](/posts/Project/04/8.png)

## 결과

![result](/posts/Project/04/deepseek-coder-33b.png)
- deepseek-coder-33b : 한국어로 작성 시, 가끔 문법에 안 맞거나 한문이 섞여서 나오는 경우가 있음. 영어로 작성 시 가장 작성이 잘 됨. 보안상 문제될 수 있음.

![result](/posts/Project/04/qwen3-32b.png)
- qwen3-32b : 영문과 한국어가 모두 표출됨. 퀄리티는 나름 준수함.

![result](/posts/Project/04/exaone3.5-32b.png)
