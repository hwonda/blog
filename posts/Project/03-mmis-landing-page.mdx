...
- [2년차 개발자의 모바일 랜딩페이지 제작기(2) - 컴포넌트 구조화](/posts/Project/02-mmis-landing-page)
...
![gaugeChart](/posts/Project/03/01.png)

[이전 글(개요)](/posts/Project/01-mmis-landing-page)에서 얘기한 것처럼, **게이지 차트** 가 랜딩페이지 개발에서 가장 어려운 기능이라 생각하고 2일을 투자하기로 계획했습니다.
...
![legend](/posts/Project/03/02.png)
...
<div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2rem'}}>
  <div>![figma](/posts/Project/03/03.png)</div>
  <div>![component](/posts/Project/03/04.png)</div>
  <div>![component](/posts/Project/03/05.png)</div>
</div>
