---
title: Github Actions와 Secrets
desc: CI/CD(Actions)를 사용해 github.io 배포할 때, 환경변수를 안전하게 관리하기
createdDate: 2024-10-16
thumbnail: /blog/posts/Etc/02/thumbnail.webp
tags: ['etc']
---
...
![github actions](/blog/posts/Etc/02/01.webp)
...
![build fail](/blog/posts/Etc/02/02.webp)

[이전 글](https://www.hwonda.com/blog/firebase-and-react-next)에서 `.env`를 사용하여 Firebase 서비스 계정 키를 관리했습니다.
...
![secrets](/blog/posts/Etc/02/03.webp)
